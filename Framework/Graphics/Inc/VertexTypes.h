...
namespace NardaEngine::Graphics
{
	...
	struct Vertex
	{
		// sets the vertex input data expected to be passed to the shader (position, normla, tangent, texcoord, blendindices and blend weight
		// must math info in the shader
