...
void FPSCameraComponent::Initialize() 
{
	...
	ASSERT(mCameraComponent != nullptr, "FPSCameraComponent: Camera component is required");
}
...
{
	ImGui::DragFloat("MoveSpeed", &mMoveSpeed, 0.1f, 0.0f, 100.0f);
	ImGui::DragFloat("ShiftSpeed", &mShiftSpeed, 0.1f, 0.0f, 1000.0f);
	ImGui::DragFloat("TurnSpeed", &mTurnSpeed, 0.001f, 0.0f, 1.0f);
}
